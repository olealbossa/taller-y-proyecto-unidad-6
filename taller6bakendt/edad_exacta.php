...
<body>
    ...
    <form action="" method="POST">
        <div class="form-group">
            <label for="exampleFormControlInput1">Seleeciona tu fecha de nacimiento:</label>
        ...
        <button type="submit" name="verificar" class="btn btn-outline-success">Calcula</button>
    </form>
